...
def eval_g_Sonar(x, p, u=None):
    ...
    # Horizontal array (shared z, multiple x)
    ...
    # Vertical array (shared x, multiple z)
    ...
    # Arbitrary paired coordinates
    elif 'x_indices' in p['hydrophones'] and 'z_indices' in p['hydrophones']:
        for x_idx, z_idx in zip(p['hydrophones']['x_indices'], p['hydrophones']['z_indices']):
